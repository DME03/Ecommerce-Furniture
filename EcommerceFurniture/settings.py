"""
Django settings for EcommerceFurniture project.
...
SECRET_KEY = 'django-insecure-j$@f(ln%id=__ht-!p-tgja*1sq_+y*l!(wjj@3jes&ixg&ime'
...
ROOT_URLCONF = 'EcommerceFurniture.urls'
...
WSGI_APPLICATION = 'EcommerceFurniture.wsgi.application'
