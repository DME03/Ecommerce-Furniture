...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Furniture', '0008_mycart_quantity_price'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Furniture.furnitureitem', verbose_name='Product')),
            ],
        ),
    ]
